...
{
  0xa2, 0x1b, 0x4f, 0xd3, 0x7c, 0xe8, 0x9a, 0x42, 0xbc, 0x6d, 0x11, 0x33, 0x55, 0x77, 0x99, 0xee, 
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0x7c, 0x3b, 0x9a, 0xf1, 0xe4, 0x2d, 0x56, 0x8f, 0x3c, 0xa1, 0x4b, 0x22, 0xd7, 0x9e, 0x05, 0x6a, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1a, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x18, .char_uuid = 0x8000 } },
  { .handle = 0x1b, .uuid = 0x8000, .permissions = 0x2a02, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_26 },
  { .handle = 0x1c, .uuid = 0x000d, .permissions = 0xa03, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x01 } },
};
